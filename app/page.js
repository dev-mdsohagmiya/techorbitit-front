...
export default function Home() {
  return (
    <div>
      ...
      <div className="max-w-[1280px] m-auto px-4 md:px-6 lg:px-0 py-10">
      ...
      <div className="max-w-[1280px] m-auto px-4 md:px-6 lg:px-0 pt-10">
        <WhyUs />
      </div>
      ...
      <div className="max-w-[1280px] m-auto px-4 md:px-6 lg:px-0 pt-8 md:pt-16 lg:pt-[220px]">
        <ContactUS />
      </div>
